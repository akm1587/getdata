...
## This script runs data processing on the Human Activity Using Smartphones
## data set
##
## Running this R script will process the data and generate a file called
## "mean-std-by-subject-activity.txt' that is the tidy data set
#
